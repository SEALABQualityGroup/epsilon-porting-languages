...
public class MainTest {
	...
	public static void main(String[] args) throws URISyntaxException, Exception {
		...
		// System.out.println(AstUtil.getChild(evlM.getAst().getFirstChild().getSecondChild(),
		// EvlParser.MESSAGE).getToken());
...
//		 System.out.println(evlAST.toExtendedStringTree());
		...
		//PortingUtil.ast2file(ewlAST, "autogenerated", "ewl");
		// PortingUtil.ast2file(evlASTGen, "evl");
